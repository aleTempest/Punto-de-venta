                    ...
                    <tr>
                        ...
                        @forelse ($clients as $client)
                            <tr>
                                ...
                                <th class="text-center">{{ $client->rfc }}</th>
                                <th class="text-center">{{ $client->business_name }}</th>
                                <th class="text-center">{{ $client->postal_code }}</th>
                                <th class="text-center">{{ $client->tax_regime }}</th>
